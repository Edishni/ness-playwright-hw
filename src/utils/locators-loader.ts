...
export const ProductLocators = {
  ...
  dialogAddToCartButton: () => locatorsLoader.getLocators('product', 'dialogAddToCartButton'),
  getDialogHeader: () => locatorsLoader.getLocators('product', 'getDialogHeader'),
  getDialog: () => locatorsLoader.getLocators('product', 'getDialog'),
